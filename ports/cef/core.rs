...
thread_local!(pub static globals: RefCell<Option<ServoCefGlobals>> = RefCell::new(None))

thread_local!(pub static message_queue: RefCell<Vec<WindowEvent>> = RefCell::new(vec!()))
